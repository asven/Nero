    ...
    public static class EmployeeManager
    {
        ...
        static EmployeeManager()
        {
            AllEmployees.Add(new Employee() { 
                ...
                Title = "",
                Certifications = "PE (MN, IN)", 
                EmailAddress = "eric.meester@neroeng.com", 
                RouteName = "Eric",
                ImagePath = "/Images/EricMeester.jpg" 
            });    
            AllEmployees.Add(new Employee() { 
                Name = "Jennifer Svennes", 
                Biography = @"Jennifer Svennes joined Nero Engineering in 2015 as a process engineer bringing additional water 
                                ...
                                services experience.", 
                EmailAddress = "jennifer.svennes@neroeng.com", 
                Title="Process Engineer", 
                Certifications = "PE (MN, IA)", 
                RouteName="Jennifer", 
                ImagePath="/Images/JenniferSvennes.jpg" });
